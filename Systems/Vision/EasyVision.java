...
public class EasyVision {
  ...
  //Get Detection Position Method:
  public static int getDetectionPosition() {
    //Main Position Integer:
    int mainPosition = 1;

    //Gets the Vision Analysis
    int analysis = pipeline.getAnalysis();
    SkystoneDeterminationPipeline.RingPosition position = pipeline.position;
